...
from utilities.load_train_data import Dataset_Pro
import errno
from metrics import ref_evaluate, no_ref_evaluate
from utilities.load_test_data import load_h5py
...
input1 = torch.randn(1, 8, 16, 16).cuda()
...
def eval_metrics(epoch, loader, mode):
    ...
    img_lr, img_lr_u, img_pan, gt = load_h5py(file_path)
...
if __name__ == "__main__":
    ...
    train_set = Dataset_Pro(opt.data_path_train)  # WV
    validate_set = Dataset_Pro(opt.data_path_test)
