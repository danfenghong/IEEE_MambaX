...
DATA_ROOT = REPO_ROOT / "data" / "multimodal" / "training_gf2"
OUTPUT_ROOT = REPO_ROOT / "outputs" / "multimodal" / "gf2"
...
parser.add_argument('--data_path_train',
                    default=str(DATA_ROOT / "train_gf2.h5"),
                    type=str, help='path of training data')

parser.add_argument("--data_path_test",
                    default=str(DATA_ROOT / "valid_gf2.h5"),
                    type=str, help='path of validation data')

parser.add_argument("--reduced_test_path",
                    default=str(DATA_ROOT / "reduced_examples" / "test_gf2_multiExm1.h5"),
